...
class PageModel extends DbModel {
  ...
  public function get_serviceList(){
    $result  = $this->get_query("select * from services");
    return $result;

  }

  #get cost by it's service id

  public function get_costByServiceId($service_id){

     $result  = $this->get_query("select * from services where id=".$service_id);
     return $result;
  }
